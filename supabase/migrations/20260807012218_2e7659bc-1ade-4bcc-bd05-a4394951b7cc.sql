...
-- 4. Privacy-first analytics (no IP, no user agent)
...
-- 5. First registered account becomes Super Admin (dev bootstrap)
...
-- 6. Mock SEPA payments for admin dashboard testing
